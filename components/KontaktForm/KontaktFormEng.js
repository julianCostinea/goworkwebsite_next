  ...
  state = {
    kontaktForm: {
      ...
      telefon: {
        ...
        valid: false,
        touched: false,
        errorMessage: "Phone number has to be between 8 and 11 characters",
      },
      description: {
        ...
        value: "",
        label: "Tell us briefly about your requests*",
        validation: {
          required: true,
        },
        valid: false,
        touched: false,
        errorMessage: "Tell us briefly about your requests",
      },
      //Honey pot fields
      phone: {
        elementConfig: {
    ...
    return (
      <div className={classes.KontaktFormContainer}>
        ...
        {this.props.noHeader ? null : (
          <React.Fragment>
            <div className={classes.kontaktFormHeader}>
              <h1>Contact</h1>
              <p style={{ fontSize: "1.25rem" }}>
              Are you interested in knowing more? <br /> Tell us briefly about your
              staffing requests, and we will contact you for a non-committal chat.
              </p>
            </div>
          </React.Fragment>
        )}
