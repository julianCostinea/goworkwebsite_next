    ...
    const kontaktForm = (
      <div className={classes.kontaktFormDiv}>
        <div className ={classes.HeaderContainer}>
          <h2>Skriv til os</h2>
          <p>
            Vi sidder klar til at hjælpe dig godt i gang. Hvis du er jobsøger,<br />
            så beder vi dig sende os en ansøgning på et aktuelt jobopslag – ikke via denne kontaktformular.
          </p>
        </div>
